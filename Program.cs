...
internal class Program
{
	...
	{
		//var o = new AdfEventAnimateTrack();
		//Console.WriteLine(o.BeatsAhead);
		//o.BeatsAhead = 4d;
		//Console.WriteLine(o.BeatsAhead); 
		
		AdfChart chart = AdfChart.ParseChart(File.ReadAllText(@"G:\Adofai levels\nullabletest.adofai"));
        Console.WriteLine(chart.GetEvents());
		File.WriteAllText(@"G:\Adofai levels\nullabletest converted.adofai", chart.ChartJson.ToJsonString());
